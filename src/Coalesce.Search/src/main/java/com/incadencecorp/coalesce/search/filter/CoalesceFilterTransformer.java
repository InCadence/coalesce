...
public class CoalesceFilterTransformer extends TransformerBase {
    ...
    public static class FilterTranslator extends TranslatorSupport implements org.opengis.filter.FilterVisitor,
        ...
        {
            // Exclude filter represents "null" when the default action is to
            // not accept any content
            // the code calling the FilterTransformer should of checked for this
            // case
            // and taken appropriate action
            return extraData; // should we consider throwing an illegal state
                              // exception?
        }

        public Object visit(IncludeFilter filter, Object extraData)
        {
            // Include filter represents "null" when the default action is to
            // include all content
            // the code calling the FilterTransformer should of checked for this
            // case
            // and taken appropriate action
        ...
        public Object visit(PropertyIsEqualTo filter, Object extraData)
        {
            ...
            {
                atts.addAttribute(null, "matchCase", "matchCase", "boolean", "false");
            }
