...
:mod:`~pyCoalesce.classes.entity` module.  All subclasses canbe imported
...
:mod:`~pyCoalesce.classes.entity` produces two notable quirks:
    ...
    * The names of the subclasses can't be changed, because the methods
      ...
      "<original_class>Sub".  To overcoming this limitation, each subclass
    ...
    * Some of the functions and methods in this module and the other
      ...
      iPython'sauto-reload feature.  Refactoring so that input tests no
      longer rely on inheritance changed has removed some and possibly all
      of these cases, but, should the problem appear, it can most likely be
      overcome by restarting the kernel and reimporting everything at once.
