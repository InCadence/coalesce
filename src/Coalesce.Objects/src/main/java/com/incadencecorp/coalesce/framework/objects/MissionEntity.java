...
public class MissionEntity extends CoalesceEntity {
    ...
    protected boolean initializeEntity(String source, String version, String title) {
        ...
        // Already Initialized?
        if (_liveStatusRecord != null || _informationRecord != null)
            return false;

        // Initialize Entity
        if (!super.initializeEntity(MissionEntity.NAME, source, version, "", "", title))
            return false;
        ...
        recordSet =
                CoalesceRecordset.create(section, MissionEntity.NAME + " Information Recordset");
        CoalesceFieldDefinition.create(recordSet, "ActionNumber",
                                       ECoalesceFieldDataTypes.STRING_TYPE, "Action Number", "U",
                                       "0");
        CoalesceFieldDefinition.create(recordSet, "IncidentNumber",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "IncidentTitle",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "IncidentDescription",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "IncidentDateTime",
                                       ECoalesceFieldDataTypes.DATE_TIME_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionName",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionType",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionDescription",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionIndicatorColor",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionIndicatorShape",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionIndicatorNumber",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionIndicatorNumberBASE10",
                                       ECoalesceFieldDataTypes.INTEGER_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionStartDateTime",
                                       ECoalesceFieldDataTypes.DATE_TIME_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionEndDateTime",
                                       ECoalesceFieldDataTypes.DATE_TIME_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionGeoLocation",
                                       ECoalesceFieldDataTypes.GEOCOORDINATE_TYPE);
        CoalesceFieldDefinition.create(recordSet, "MissionAddress",
                                       ECoalesceFieldDataTypes.STRING_TYPE);
    ...
    protected boolean initializeReferences() {
        ...
        if (this._liveStatusRecord == null) {
            CoalesceRecordset recordSet =
                    (CoalesceRecordset) this.getCoalesceObjectForNamePath(MissionEntity.NAME
        ...
        if (this._informationRecord == null) {
            CoalesceRecordset recordSet =
                    (CoalesceRecordset) this.getCoalesceObjectForNamePath(MissionEntity.NAME + "/"
                            + MissionEntity.NAME + " Information Section/" + MissionEntity.NAME
    ...
    public EMissionStatuses getCurrentStatus() {
        return EMissionStatuses.fromLabel(this._liveStatusRecord.getFieldByName("CurrentStatus")
                .getBaseValue());
    }
    ...
    public CoalesceIntegerField getMissionIndicatorNumberBASE10() {
        return (CoalesceIntegerField) _informationRecord
                .getFieldByName("MissionIndicatorNumberBASE10");
    }
