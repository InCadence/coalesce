...
public class MissionEntity extends CoalesceEntity {
	...
	public boolean initialize() {
		if (!initializeEntity(MissionEntity.SOURCE, "1.0",
	...
	protected boolean initializeEntity(String source, String version, String title) {
		...
		CoalesceFieldDefinition.create(recordSet, "ActionNumber", ECoalesceFieldDataTypes.STRING_TYPE, "Action Number",
				"U", "0");
	...
	protected boolean initializeReferences() {
		...
		if (this._liveStatusRecord == null) {
			CoalesceRecordset recordSet = (CoalesceRecordset) this
					.getCoalesceObjectForNamePath(MissionEntity.NAME + "/Live Status Section/Live Status Recordset");
