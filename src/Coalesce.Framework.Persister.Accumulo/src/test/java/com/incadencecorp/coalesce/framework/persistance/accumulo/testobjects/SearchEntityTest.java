...
public class SearchEntityTest {
     ...
     *  */
    public static void addPointsToEntity1(CoalesceSearchTestEntity1 searchEntity1) throws CoalesceDataFormatException
    {
        ...
        searchEntity1.getStringPointData().setValue("firstentitypoint");
        searchEntity1.getIntegerPointData().setValue(1);
        searchEntity1.getDateTimePointData().setValue(new DateTime());
        ...
        searchEntity1.getStringMultiPointData().setValue("somestringdatahere");
        searchEntity1.getBooleanMultipointData().setValue(true);
        searchEntity1.getDoubleMultipointData().setValue(5.0d);
        searchEntity1.getFloatMultipointData().setValue((float) 0.1);
        searchEntity1.getDateTimeMultiPointData().setValue(new DateTime());
		...
		searchEntity1.getPolygonAreaData().setValue(poly);
        searchEntity1.getStringAreaData().setValue("myareaname");
		searchEntity1.getBooleanAreaData().setValue(true);
		searchEntity1.getDateTimeAreaData().setValue(new DateTime());
