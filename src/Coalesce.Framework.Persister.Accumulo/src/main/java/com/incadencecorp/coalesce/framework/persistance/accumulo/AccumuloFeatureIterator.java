 ...
 */
public class AccumuloFeatureIterator extends CoalesceIterator<Map<String, DefaultFeatureCollection>> {
    ...
    public void iterate(CoalesceEntity entity, Map<String, DefaultFeatureCollection> features) throws CoalesceException
    {
        processAllElements(entity, features);
    }

    @Override
    protected boolean visitCoalesceEntity(CoalesceEntity entity, Map<String, DefaultFeatureCollection> features)
            throws CoalesceException
    {
        ...
        try
        {
            ...
            if (featureType != null)
            {
                DefaultFeatureCollection collection = features.get(featureName);
    ...
    protected boolean visitCoalesceLinkageSection(CoalesceLinkageSection section,
                                                  Map<String, DefaultFeatureCollection> features) throws CoalesceException
    {
    ...
    @Override
    protected boolean visitCoalesceRecordset(CoalesceRecordset recordset, Map<String, DefaultFeatureCollection> features)
            throws CoalesceException
    {
            ...
            if (featureType != null)
            {
                ...
                for (CoalesceRecord record : recordset.getAllRecords())
                {
                    ...
                    setFeatureAttribute(feature,
                                        ...
                                        entity.getTitle());
                    setFeatureAttribute(feature,
                                        normalizer.normalize(recordset.getName(), "recordkey"),
                                        ECoalesceFieldDataTypes.STRING_TYPE,
                                        record.getKey());

                    for (CoalesceField<?> field : record.getFields())
                    {
                        String fieldName = normalizer.normalize(recordset.getName(), field.getName());
                    ...
                    if (descriptor != null)
                    {
                        ...
                        {
                            LOGGER.debug("Default Geometry ({}) = ({})", descriptor.getLocalName(), feature.getAttribute(descriptor.getLocalName()).toString());
                        }
                    }
                    else
                    {
