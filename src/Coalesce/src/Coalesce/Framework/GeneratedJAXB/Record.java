 ...
 *       &lt;sequence>
 *         &lt;element ref="{}field_node" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Record {
    ...
    @XmlElement(name = "field_node")
    protected List<Field> fieldNode;
    ...
    /**
     * Gets the value of the fieldNode property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fieldNode property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFieldNode().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Field> getFieldNode() {
        if (fieldNode == null) {
            fieldNode = new ArrayList<Field>();
        }
