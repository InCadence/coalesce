...
public class XsdLinkage extends XsdDataObject {
	...
	public static XsdLinkage Create(XsdLinkageSection parent) {
			...
			if (!linkage.Initialize(parent, entityLinkage))
				return null;
	...
	public CallResult EstablishLinkage(CoalesceEntity Entity1, ELinkTypes LinkType, CoalesceEntity Entity2,
			String ClassificationMarking, String ModifiedBy, String InputLang) {
		try {
