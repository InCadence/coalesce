...
public interface ICoalesceFieldDefinition extends ICoalesceObject {
    ...
    /**
     * @return the value of the FieldDefinitions's description attribute.
     */
    String getDescription();

    /**
     * Sets the value of the FieldDefinitions's description attribute.
     *
     * @param value String to be the FieldDefinition's description attribute.
     */
