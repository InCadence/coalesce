...
public interface ICoalesceField<T> {
    ...
    /**
     * Return the Key value of the Field's most recent previous history {@link com.incadencecorp.coalesce.framework.datamodel.CoalesceDataObject}.
     * 
    ...
    /**
     * Sets the Key value corresponding to the Field's most recent previous history {@link com.incadencecorp.coalesce.framework.datamodel.CoalesceDataObject}.
     * 
