...
public final class CoalesceErrors {
     ...
     */
    public static final String INVALID_DATA_TYPE = "Field (%s) of type (%s) in Entity (%s) does not match its definition of (%s)";
    ...
    /**
     * Error reported when the key segment of an endpoint doesn't match the key extracted from the object
     * submitted in a PUT or POST operation. Format: {@value #KEY_MISMATCH}
     */
    public static final String KEY_MISMATCH = "Endpoint key (%s) does not match the key (%s) contained in " +
            "the submitted object";
    /**
     * Error reported when the key segment of an endpoint doesn't match the key generated by a hash of the
     * name, source, and version of an object submitted in a PUT or POST operation. Format:
     * {@value #INVALID_KEY}
     */
    public static final String INVALID_KEY = "Endpoint key (%s) does not match the key (%s) generated from " +
            "the submitted object's name, source, and version.";
}
