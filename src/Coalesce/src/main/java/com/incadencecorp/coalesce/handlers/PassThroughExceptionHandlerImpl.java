...
/**
 * This implementation always returns false indicating that the caller needs to
 * handle the error message.
 * 
 * @author n78554
 *
 */
public class PassThroughExceptionHandlerImpl extends CoalesceComponentImpl implements IExceptionHandler {
