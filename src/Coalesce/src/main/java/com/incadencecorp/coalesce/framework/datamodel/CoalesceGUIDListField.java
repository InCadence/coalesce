 ...
 */
public class CoalesceGUIDListField extends CoalesceListField<UUID[]> {

    @Override
    public UUID[] getValue() throws CoalesceDataFormatException
    {
        return getGuidListValue();
    }

    @Override
    public void setValue(UUID[] values)
    {
        setTypedValue(values);
    }

    @Override
    public void addValues(UUID[] values)
    {
