...
public class ISO3166Country implements Serializable, Comparable<ISO3166Country> {
     ...
     * 
     * @param alpha2 The two character alpha string representation of the country allowed object is {@link String }
     * @param alpha3 The three character alpha string representation of the country allowed object is {@link String }
     * @param name The full name string of the country allowed object is {@link String }
     */
