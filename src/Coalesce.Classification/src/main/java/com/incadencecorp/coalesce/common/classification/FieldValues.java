...
public class FieldValues {
    ...
    public static List<ISO3166Country> getListOfCountries()
    {
        ...
        countryList.add(new ISO3166Country("CI", "CIV", "C�TE D'IVOIRE"));
        ...
        countryList.add(new ISO3166Country("RE", "REU", "R�UNION"));
        ...
        countryList.add(new ISO3166Country("AX", "ALA", "�LAND ISLANDS"));
        ...
        countryList.add(new ISO3166Country("BL", "BLM", "SAINT BARTH�LEMY"));
        ...
        countryList.add(new ISO3166Country("CW", "CUW", "CURA�AO"));
