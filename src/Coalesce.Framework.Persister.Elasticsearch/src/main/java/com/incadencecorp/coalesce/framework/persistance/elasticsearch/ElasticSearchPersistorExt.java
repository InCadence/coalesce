...
import com.incadencecorp.coalesce.framework.persistance.elasticsearch.mappers.StoredProcedureArgumentMapper;
 ...
 * @author n78554
 */
public class ElasticSearchPersistorExt extends ElasticSearchPersistor implements ICoalesceSearchPersistor {

    private static final Logger LOGGER = LoggerFactory.getLogger(ElasticSearchPersistorExt.class);
    ...
    /**
     * Uses {@link ElasticSearchSettings} to configure the database settings.
     */
    public ElasticSearchPersistorExt()
    {
        setConnectionSettings(ElasticSearchSettings.getServerConn());
        setSchema(ElasticSearchSettings.getDatabaseSchema());
     ...
     */
    public ElasticSearchPersistorExt(String userId, String password)
    {

        ElasticSearchSettings.setUserName(userId);
        ElasticSearchSettings.setUserPassword(password);
    ...
    public final void registerTemplate(final CoalesceEntityTemplate... templates) throws CoalescePersistorException
    {
        ...
        try (CoalesceDataConnectorBase conn = new ElasticSearchDataConnector(getConnectionSettings(), getSchemaPrefix()))
        {
            ...
            try
            {
                ...
                {
                    // Create Tables
                    ElasticSearchRegisterIterator iterator = new ElasticSearchRegisterIterator();
    ...
    public SearchResults search(Query query) throws CoalescePersistorException
    {
        ...
        {
            // Create SQL Query
            ElasticSearchCoalescePreparedFilter preparedFilter = new ElasticSearchCoalescePreparedFilter(ElasticSearchSettings.getDatabaseSchema());
    ...
    private List<CoalesceParameter> getParameters(ElasticSearchCoalescePreparedFilter filter) throws ParseException
    {
    ...
    public int executeUpdate(String query, CoalesceParameter... parameters)
    {
        ...
        try (CoalesceDataConnectorBase conn = new ElasticSearchDataConnector(getConnectionSettings(), getSchema()))
        {
