 ...
 * @author n78554
 */
public class ElasticSearchCoalescePreparedFilter extends PostgisPSFilterToSql implements ICoalesceExpressionVistor {
    ...
    private static final int SSRID = ElasticSearchSettings.getSRID();
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ElasticSearchCoalescePreparedFilter.class);
     ...
     * @param schema
     */
    public ElasticSearchCoalescePreparedFilter(String schema)
    {
