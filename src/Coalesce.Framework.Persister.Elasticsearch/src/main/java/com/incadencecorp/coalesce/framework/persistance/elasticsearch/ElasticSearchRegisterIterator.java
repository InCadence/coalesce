 ...
 *
 */
public class ElasticSearchRegisterIterator extends CoalesceIterator<CoalesceDataConnectorBase> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ElasticSearchRegisterIterator.class);
    ...
    private static final String CREATE_PROCEDURE_FORMAT = "CREATE OR REPLACE FUNCTION %s_insertorupdate(%s) RETURNS void AS"
            ...
            + "COMMENT ON FUNCTION %s_insertorupdate(%s) IS 'Generated by DSS (%s)';";
    ...
    private static final boolean CREATE_FK = ElasticSearchSettings.isUseForeignKeys();
    private String schema = ElasticSearchSettings.getDatabaseSchema();
    private int srid = ElasticSearchSettings.getSRID();
     ...
     * {@link ElasticSearchSettings#getDatabaseSchema()}.
     * 
     * @param schema
     */
     ...
     * {@link ElasticSearchSettings#getSRID()}.
     * 
     * @param srid
     */
