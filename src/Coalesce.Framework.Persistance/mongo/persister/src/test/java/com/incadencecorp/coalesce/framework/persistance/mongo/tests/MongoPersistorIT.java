...
import com.incadencecorp.coalesce.framework.persistance.mongo.MongoPersistor;
 ...
 */
public class MongoPersistorIT extends AbstractCoalescePersistorTest<MongoPersistor> {
    ...
    @Override
    protected MongoPersistor createPersister()
    {
        return new MongoPersistor();
    }
