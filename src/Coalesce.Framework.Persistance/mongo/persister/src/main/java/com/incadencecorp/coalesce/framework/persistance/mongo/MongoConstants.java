...
/**
 * Constants used in the Mongo implementation.
 *
 * @author Derek Clemenzi
 */
public class MongoConstants {

    private static final ICoalesceNormalizer NORMALIZER = new MongoNormalizer();
    ...
    public static String normalize(PropertyName property)
    {
