...
import com.incadencecorp.coalesce.framework.persistance.sql.impl.SQLQueryHelper;
 ...
 * @author GGaito
 */
public class SQLCoalescePreparedFilter extends PostgisPSFilterToSql implements ICoalesceExpressionVistor {
    ...
    //private static final int SSRID = SQLPersisterImplSettings.getSRID();
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SQLCoalescePreparedFilter.class);
     ...
     * @param schema
     */
    public SQLCoalescePreparedFilter(String schema)
    {
...
//        SRIDs.add(currentSRID);
    ...
    {
        return SQLQueryHelper.getOrderBy(sortByList);
    }
