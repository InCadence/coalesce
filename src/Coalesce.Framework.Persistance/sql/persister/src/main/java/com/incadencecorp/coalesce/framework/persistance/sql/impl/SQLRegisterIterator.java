 ...
 *
 */
public class SQLRegisterIterator extends CoalesceIterator<CoalesceDataConnectorBase> {

    private static final Logger LOGGER = LoggerFactory.getLogger(SQLRegisterIterator.class);
    ...
    private static final String CREATE_TABLE_FORMAT = "CREATE TABLE IF NOT EXISTS %s.%s(\r%s\r);";
    ...
    /**
     * Defines the SQL type to use for coordinate types
     */
    private static final String ST_TYPE = "geography";
    private static final boolean CREATE_FK = SQLPersisterImplSettings.isUseForeignKeys();
    private String schema = SQLPersisterImplSettings.getDatabaseSchema();
    private int srid = SQLPersisterImplSettings.getSRID();
    private final ICoalesceNormalizer normalizer;



    public SQLRegisterIterator(ICoalesceNormalizer normalizer)
    {
        if (normalizer == null)
        {
     ...
     * {@link SQLPersisterImplSettings#getDatabaseSchema()}.
     * 
     * @param schema
     */
     ...
     * {@link SQLPersisterImplSettings#getSRID()}.
     *
     * @param srid
     */
