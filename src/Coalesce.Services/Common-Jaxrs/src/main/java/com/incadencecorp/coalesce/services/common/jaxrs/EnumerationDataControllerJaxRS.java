...
import com.incadencecorp.coalesce.services.common.controllers.EnumerationDataController;
...
public class EnumerationDataControllerJaxRS extends EnumerationDataController implements IEnumerationDataControllerJaxRS {
     ...
     * Default Constructor
     */
    public EnumerationDataControllerJaxRS(CoalesceSearchFramework framework)
    {
        super(framework);
    }
