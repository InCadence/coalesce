...
import com.incadencecorp.coalesce.services.crud.tasks.CreateDataObjectTask;

public class CreateDataObjectJob extends AbstractXSDJobBase<DataObjectXmlRequest, StringResponse, ResultsType> {
